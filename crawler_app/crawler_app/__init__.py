...
def init_routing(config):
    ...
    config.add_handler('node2','demo/node0/node2',handler=demo.DemoController,action="node2")
    config.add_handler('node3','demo/node0/node3',handler=demo.DemoController,action="node3")
    config.add_handler('node4','demo/node0/node2/node4',handler=demo.DemoController,action="node4")
    config.add_handler('node5','demo/node0/node2/node5',handler=demo.DemoController,action="node5")
    config.add_handler('node6','demo/node0/node3/node6',handler=demo.DemoController,action="node6")
    config.add_handler('node7','demo/node0/node3/node6/node7',handler=demo.DemoController,action="node7")
    config.add_handler('node8','demo/node0/node3/node6/node8',handler=demo.DemoController,action="node8")
    config.add_handler('node9','demo/node0/node3/node6/node9',handler=demo.DemoController,action="node9")
    config.add_handler('node10','demo/node0/node3/node6/node8/node10',handler=demo.DemoController,action="node10")
    # config.add_handler('node1','demo/node0/node1',handler=demo.DemoController,action='node1')
    config.scan()
